...
const applyPercentDiscount = (product, discount) => {
    product,displayPrice = productBasePrice * (1 - discount)
}

const applyFlatRateDiscount = (product, discount) => {
    product.displayPrice - 56
}
...
function makeSandwich(bread) {
    ...
    return function(ingredients){
        let order = `you ordered a ${ingredients} sandwich`
...
const makeWheatSandwhich = makeWheatSandwich('wheat')
const makeWhiteSandwhich = makeSandwhich('white')

console.log(makeWheatSandwhich(['turkey','ham','cheese']))
console.log(makeWhiteSandwhich([`cheese`]))
